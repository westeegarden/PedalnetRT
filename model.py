...
class PedalNet(pl.LightningModule):
    def __init__(self, hparams):
        ...
        self.validation_step_outputs = []  # Initialize outputs list
    ...
    def validation_step(self, batch, batch_idx):
        ...
        y_pred = self.forward(x)
        loss = error_to_signal(y[:, :, -y_pred.size(2):], y_pred).mean()
        self.validation_step_outputs.append(loss)  # Store loss
    ...
    def on_validation_epoch_end(self):
        ...
        self.log("avg_val_loss", avg_loss)  # Log average validation loss
